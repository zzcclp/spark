...
public abstract class SpecificParquetRecordReaderBase<T> extends RecordReader<Void, T> {
  ...
  protected boolean useOldApiToReadFooter = false;
  ...
  public void initialize(InputSplit inputSplit, TaskAttemptContext taskAttemptContext)
    ...
    if (rowGroupOffsets == null) {
      ...
      if (footer == null) {
        footer = ParquetFileMetaUtils.readFooterByRange(metaCacheEnabled, useOldApiToReadFooter,
                configuration, file,
      ...
      if (footer == null) {
        footer = ParquetFileMetaUtils.readFooterByNoFilter(metaCacheEnabled, useOldApiToReadFooter,
                configuration, file);
      }
  ...
  public void setUseOldApiToReadFooter(boolean useOldApiToReadFooter) {
    this.useOldApiToReadFooter = useOldApiToReadFooter;
  }
